<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="gerenxinxi.aspx.cs" Inherits="hirain.gerenxinxi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                <span>个人征信</span>
        <asp:TextBox ID="gerenzhengxin" runat="server"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />

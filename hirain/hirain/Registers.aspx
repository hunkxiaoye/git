<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registers.aspx.cs" Inherits="hirain.Registers" %>
            ...
            <form id="Form1"  runat="server">
                <ul>
                    ...
                    <li><span class="name">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 码：<b>*</b></span><span class="wenben">
                        <asp:TextBox ID="PassWord" runat="server" CssClass="password_box" TextMode="Password"></asp:TextBox>
                    </span></li>
                    <li><span class="name">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 称：<b>*</b></span><span class="wenben">
                        <asp:TextBox ID="NickName"
                        runat="server" ></asp:TextBox>
                    </span></li>
<%--                    <li><span class="name">性 别：&nbsp;</span><span class="wenben">
                        <asp:TextBox ID="Sex"
                        runat="server" ></asp:TextBox>
                    </span></li>
                    <li><span class="name">年 龄：<b>*</b></span><span class="wenben">
                        <asp:TextBox ID="Age"
                        runat="server" ></asp:TextBox>
                    </span><span class="tip"></span></li>--%>
                    ...
                    <li><span class="terms">
                        <input name="read_box" class="read_box" type="checkbox" value="" />
                        我已阅读并接受“服务条款”和“隐私保护和个人信息利用政策”</span></li>
